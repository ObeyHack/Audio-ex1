...
def self_check_fft_stft():
    ...
    plot_fft(sine_1Khz)
    plot_fft(sine_3Khz)
    plot_fft(sine_1Khz_3Khz)
    # 3.
    # plot spectrogram
    plot_spectrogram(torch.cat([sine_1Khz, sine_3Khz, sine_1Khz_3Khz], dim=-1), n_fft=1024)
...
def audio_check_fft_stft():
    ...
    # 2.
    plot_fft(phone_wavs[1])
    plot_fft(phone_wavs[2])
    # 3.
    # plot spectrogram
    plot_spectrogram(torch.cat(phone_wavs, dim=-1), n_fft=1024)
